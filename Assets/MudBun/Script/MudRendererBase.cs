    ...
    */
    ...
    private RenderGeometryTypeEnum RenderGeometryType
    {
      get
      {
        ...
        return RenderGeometryTypeEnum.Unknon;
      }
    }
    ...
    private RenderGeometryTypeEnum m_prevRenderGeometryType = RenderGeometryTypeEnum.Unknon;
    ...
    public AabbTree<MudBrushBase> m_aabbTree;
    ...
    {
      Transform [] aBone;
      return GenerateMesh(meshType, null, out aBone, async, mesh, uvGeneration, weldVertices, optimizeMeshForRendering);
    }
    ...
    private void OnGenPointsBufferRead(AsyncGPUReadbackRequest request)
    {
      ...
      OnMeshGenerated?.Invoke(pendingMeshData.Mesh);
    ...
    )
    {
      ...
      if (meshType == GeneratedMeshType.Standard)
      {
        ...
        bool uvGenerated = GenerateUV(mesh, uvGeneration);
    ...
    virtual protected bool GenerateUV(Mesh mesh, UVGenerationMode mode) { return false; }
